...
'VK_SHOW_COMMAND'=>'Отображение команды',
'VK_SHOW'=>'Показать',
'VK_HIDE'=>'Скрыть',
...
'HELP_TITLE'=>'Имя команды (отображается на клавиатуре в VK клиенте)',
'HELP_DESCRIPTION'=>'Описание команды',
'HELP_ACCESS_CONTROL'=>'Ограничение доступа к команде',
'HELP_COUNTROW'=>'Количество кнопок команд в одной строке на клавиатуре в VK клиенте',
'HELP_ЕНЗУ'=>'Количество кнопок команд в одной строке на клавиатуре в VK клиенте'
